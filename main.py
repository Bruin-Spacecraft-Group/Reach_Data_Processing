...
#initiate socket to recieve data from ground station raspi
RECIEVE_FROM_IP = ""
RECIEVE_FROM_PORT = 5010
try:
	recieveSock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
	recieveSock.bind((RECIEVE_FROM_IP, RECIEVE_FROM_PORT))
except:
	print "couldn't bind recieve port"
...
try:
	while True:
		#get data
		dataString, addr = recieveSock.recvfrom(1024) # buffer size is 1024 bytes
